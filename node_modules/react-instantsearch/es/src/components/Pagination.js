...
function getPages(currentPage, maxPages, padding) {
  ...
  if (size === maxPages) return _range(1, maxPages + 1);
...
var Pagination = function (_Component) {
  ...
  _createClass(Pagination, [{
    ...
    value: function render() {
      ...
      return React.createElement(ListComponent, _extends({}, otherProps, {
        cx: cx,
        items: items,
        onSelect: refine,
        createURL: createURL
