...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Dosáhl jsi limitu pro počet pokusů o změnu hesla. Prosím počkej před dalším pokusem.',
    ...
    login: {
      ...
      'lock.network': 'Nepodařilo se spojit se serverem. Prosím zkontroluj připojení a zkus to znovu.',
      'lock.popup_closed': 'Vyskakovací okno zavřeno. Zkus to znovu.',
      'lock.unauthorized': 'Práva nebyla udělena. Zkus to znovu.',
      'lock.mfa_registration_required': 'Je požadováno vícefaktorové ověření, ale zařízení není registrováno. Prosím registruj jej, než budeš pokračovat.',
      'lock.mfa_invalid_code': 'Chybný kód. Prosím zkus to znovu.',
      password_change_required: 'Je třeba aktualizovat heslo, neboť jde o první přihlášení; mohla také vypršet platnost hesla.',
      password_leaked: 'Zablokovali jsme uživatelský účet, protože došlo k možnému úniku hesla na jiné webové stránce. Poslali jsme instrukce k odblokování na email.',
      too_many_attempts: 'Účet byl zablokován z důvodu příliš velkého počtu pokusů o přihlášení.',
      session_missing: 'Nemohl jsem dokončit váš požadavek na ověření. Zkus to znovu po zavření všech otevřených dialogových oken.',
  ...
  forgotPasswordInstructions: 'Prosím zadej emailovou adresu. Pošleme ti email, díky němuž si budeš moci změnit heslo.',
  ...
  passwordlessEmailAlternativeInstructions: 'Případně zadej email pro přihlášení <br/>nebo vytvoření účtu',
  ...
  passwordlessSMSAlternativeInstructions: 'Případně zadej telefon pro přihlášení<br/>nebo vytvoření účtu.',
