...
exports.default = {
  error: {
    ...
    login: {
      ...
      password_change_required: 'Du må oppdatere ditt passord, fordi dette enten er den første gangen du logger inn, eller at ditt passord har utløpt.', // TODO: verify error code
      password_leaked: 'Vi har oppdaget en potensiell sikkerhetsrisiko med denne brukerkontoen. For å beskytte deg mot misbruk, så har vi blokkert brukerkontoen med den aktuelle innloggingen. Vi har sendt deg en epost med instruksjoner for hvordan du gjenåpner brukerkontoen din.',
  ...
  forgotPasswordInstructions: 'Vennligst skriv inn din e-postadresse, og vi vil sende den en epost hvor du kan nullstille ditt passord.',
  ...
  passwordlessEmailAlternativeInstructions: 'Eller, skriv inn din epost-adresse for å logge inn <br/> eller opprette en brukerkonto',
