...
},{"yo-yoify/lib/appendChild":83}],100:[function(require,module,exports){
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_onload=require("on-load"),FileList=require("./FileList"),Tabs=require("./Tabs"),FileCard=require("./FileCard"),UploadBtn=require("./UploadBtn"),_require=require("../../core/Utils"),isTouchDevice=_require.isTouchDevice,toArray=_require.toArray,_require2=require("./icons"),closeIcon=_require2.closeIcon;module.exports=function(e){function t(t){t.preventDefault(),toArray(t.target.files).forEach(function(t){e.addFile({source:e.id,name:t.name,type:t.type,data:t})})}function a(t){t.preventDefault(),toArray(t.clipboardData.items).forEach(function(t){if("file"===t.kind){var a=t.getAsFile();e.log("File pasted"),e.addFile({source:e.id,name:t.name,type:t.type,data:a})}})}var i,n,r,l,s,o,d,p,u,c,h,b;return b=document.createElement("div"),_onload(b,function(){return e.updateDashboardElWidth()},null,5),b.setAttribute("aria-hidden",""+String(e.inline?"false":e.modal.isHidden)),b.setAttribute("aria-label",""+String(e.inline?e.i18n("dashboardTitle"):e.i18n("dashboardWindowTitle"))),b.setAttribute("role","dialog"),b.onpaste=a,b.setAttribute("class","Uppy UppyTheme--default UppyDashboard\n                          "+String(isTouchDevice()?"Uppy--isTouchDevice":"")+"\n                          "+String(e.semiTransparent?"UppyDashboard--semiTransparent":"")+"\n                          "+String(e.inline?"":"UppyDashboard--modal")+"\n                          "+String(e.isWide?"UppyDashboard--wide":"")),_appendChild(b,[" ",(i=document.createElement("div"),i.onclick=function(){},i.setAttribute("class","UppyDashboard-overlay"),i)," ",(h=document.createElement("div"),h.setAttribute("tabindex","0"),h.setAttribute("style","\n          "+String(e.inline&&e.maxWidth?"max-width: "+e.maxWidth+"px;":"")+"\n          "+String(e.inline&&e.maxHeight?"max-height: "+e.maxHeight+"px;":"")+"\n         "),h.setAttribute("class","UppyDashboard-inner"),_appendChild(h,[" ",(n=document.createElement("button"),n.setAttribute("type","button"),n.setAttribute("aria-label",""+String(e.i18n("closeModal"))),n.setAttribute("title",""+String(e.i18n("closeModal"))),n.onclick=e.hideModal,n.setAttribute("class","UppyDashboard-close"),_appendChild(n,[closeIcon()]),n)," ",(c=document.createElement("div"),c.setAttribute("class","UppyDashboard-innerWrap"),_appendChild(c,[" ",Tabs({files:e.files,handleInputChange:t,acquirers:e.acquirers,panelSelectorPrefix:e.panelSelectorPrefix,showPanel:e.showPanel,i18n:e.i18n})," ",FileCard({files:e.files,fileCardFor:e.fileCardFor,done:e.fileCardDone,metaFields:e.metaFields,log:e.log,i18n:e.i18n})," ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboard-filesContainer"),_appendChild(l,[" ",FileList({acquirers:e.acquirers,files:e.files,handleInputChange:t,showFileCard:e.showFileCard,showProgressDetails:e.showProgressDetails,totalProgress:e.totalProgress,totalFileCount:e.totalFileCount,info:e.info,note:e.note,i18n:e.i18n,log:e.log,removeFile:e.removeFile,pauseAll:e.pauseAll,resumeAll:e.resumeAll,pauseUpload:e.pauseUpload,startUpload:e.startUpload,cancelUpload:e.cancelUpload,resumableUploads:e.resumableUploads,isWide:e.isWide})," ",(r=document.createElement("div"),r.setAttribute("class","UppyDashboard-actions"),_appendChild(r,[" ",!e.hideUploadButton&&!e.autoProceed&&e.newFiles.length>0?UploadBtn({i18n:e.i18n,startUpload:e.startUpload,newFileCount:e.newFiles.length}):null," "]),r)," "]),l)," ",(p=document.createElement("div"),p.setAttribute("role","tabpanel"),p.setAttribute("aria-hidden",""+String(e.activePanel?"false":"true")),p.setAttribute("class","UppyDashboardContent-panel"),_appendChild(p,[" ",(d=document.createElement("div"),d.setAttribute("class","UppyDashboardContent-bar"),_appendChild(d,[" ",(s=document.createElement("h2"),s.setAttribute("class","UppyDashboardContent-title"),_appendChild(s,[" ",e.i18n("importFrom")," ",e.activePanel?e.activePanel.name:null," "]),s)," ",(o=document.createElement("button"),o.setAttribute("type","button"),o.onclick=e.hideAllPanels,o.setAttribute("class","UppyDashboardContent-back"),_appendChild(o,[e.i18n("done")]),o)," "]),d)," ",e.activePanel?e.activePanel.render(e.state):""," "]),p)," ",(u=document.createElement("div"),u.setAttribute("class","UppyDashboard-progressindicators"),_appendChild(u,[" ",e.progressindicators.map(function(t){return t.render(e.state)})," "]),u)," "]),c)," "]),h)," "]),b};
},{"../../core/Utils":87,"./FileCard":101,"./FileList":104,"./Tabs":105,"./UploadBtn":106,"./icons":108,"on-load":48,"yo-yoify/lib/appendChild":83}],101:[function(require,module,exports){
"use strict";var _appendChild=require("yo-yoify/lib/appendChild"),_svgNamespace="http://www.w3.org/2000/svg",getFileTypeIcon=require("./getFileTypeIcon"),_require=require("./icons"),checkIcon=_require.checkIcon;module.exports=function(e){function t(e){var t=e.target.value,a=e.target.attributes.name.value;f[a]=t}var a,i,r,n,s,l,d,p,c,o,u,b,m,h,A,y,C,g,v,E,F=!!e.fileCardFor&&e.files[e.fileCardFor],f={};return d=document.createElement("div"),d.setAttribute("aria-hidden",""+String(!e.fileCardFor)),d.setAttribute("class","UppyDashboardFileCard"),_appendChild(d,[" ",(n=document.createElement("div"),n.setAttribute("class","UppyDashboardContent-bar"),_appendChild(n,[" ",(i=document.createElement("h2"),i.setAttribute("class","UppyDashboardContent-title"),_appendChild(i,["Editing ",(a=document.createElement("span"),a.setAttribute("class","UppyDashboardContent-titleFile"),_appendChild(a,[F.meta?F.meta.name:F.name]),a)]),i)," ",(r=document.createElement("button"),r.setAttribute("type","button"),r.setAttribute("title","Finish editing file"),r.onclick=function(){return e.done(f,F.id)},r.setAttribute("class","UppyDashboardContent-back"),r.textContent="Done",r)," "]),n)," ",e.fileCardFor?(m=document.createElement("div"),m.setAttribute("class","UppyDashboardFileCard-inner"),_appendChild(m,[" ",(p=document.createElement("div"),p.setAttribute("style","background-color: "+String(getFileTypeIcon(F.type.general,F.type.specific).color)),p.setAttribute("class","UppyDashboardFileCard-preview"),_appendChild(p,[" ",F.preview?(h=document.createElement("img"),h.setAttribute("alt",""+String(F.name)),h.setAttribute("src",""+String(F.preview)),h):(E=document.createElement("div"),E.setAttribute("class","UppyDashboardItem-previewIconWrap"),_appendChild(E,[" ",(A=document.createElement("span"),A.setAttribute("style","color: "+String(getFileTypeIcon(F.type.general,F.type.specific).color)),A.setAttribute("class","UppyDashboardItem-previewIcon"),_appendChild(A,[getFileTypeIcon(F.type.general,F.type.specific).icon]),A)," ",(v=document.createElementNS(_svgNamespace,"svg"),v.setAttribute("width","72"),v.setAttribute("height","93"),v.setAttribute("viewBox","0 0 72 93"),v.setAttribute("class","UppyDashboardItem-previewIconBg"),_appendChild(v,[(g=document.createElementNS(_svgNamespace,"g"),_appendChild(g,[(y=document.createElementNS(_svgNamespace,"path"),y.setAttribute("d","M24.08 5h38.922A2.997 2.997 0 0 1 66 8.003v74.994A2.997 2.997 0 0 1 63.004 86H8.996A2.998 2.998 0 0 1 6 83.01V22.234L24.08 5z"),y.setAttribute("fill","#FFF"),y),(C=document.createElementNS(_svgNamespace,"path"),C.setAttribute("d","M24 5L6 22.248h15.007A2.995 2.995 0 0 0 24 19.244V5z"),C.setAttribute("fill","#E4E4E4"),C)]),g)]),v)," "]),E)," "]),p)," ",(b=document.createElement("div"),b.setAttribute("class","UppyDashboardFileCard-info"),_appendChild(b,[" ",(u=document.createElement("fieldset"),u.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(u,[" ",(c=document.createElement("label"),c.setAttribute("class","UppyDashboardFileCard-label"),c.textContent="Name",c)," ",(o=document.createElement("input"),o.setAttribute("name","name"),o.setAttribute("type","text"),o.setAttribute("value",""+String(F.meta.name)),o.onkeyup=t,o.setAttribute("class","UppyDashboardFileCard-input"),o)," "]),u)," ",function(a){return(e.metaFields||[]).map(function(e){var i,r,n;return n=document.createElement("fieldset"),n.setAttribute("class","UppyDashboardFileCard-fieldset"),_appendChild(n,[" ",(i=document.createElement("label"),i.setAttribute("class","UppyDashboardFileCard-label"),_appendChild(i,[e.name]),i)," ",(r=document.createElement("input"),r.setAttribute("name",""+String(e.id)),r.setAttribute("type","text"),r.setAttribute("value",""+String(a.meta[e.id])),r.setAttribute("placeholder",""+String(e.placeholder||"")),r.onkeyup=t,r.setAttribute("class","UppyDashboardFileCard-input"),r)]),n})}(F)," "]),b)," "]),m):null," ",(l=document.createElement("div"),l.setAttribute("class","UppyDashboard-actions"),_appendChild(l,[" ",(s=document.createElement("button"),s.setAttribute("type","button"),s.setAttribute("title","Finish editing file"),s.onclick=function(){return e.done(f,F.id)},s.setAttribute("class","UppyButton--circular UppyButton--blue UppyDashboardFileCard-done"),_appendChild(s,[checkIcon()]),s)," "]),l)," "]),d};
},{"./getFileTypeIcon":107,"./icons":108,"yo-yoify/lib/appendChild":83}],102:[function(require,module,exports){
...
},{"../../core/Utils":87,"./FileItemProgress":103,"./getFileTypeIcon":107,"./icons":108,"prettier-bytes":52,"yo-yoify/lib/appendChild":83}],103:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],104:[function(require,module,exports){
...
},{"./ActionBrowseTagline":99,"./FileItem":102,"./icons":108,"yo-yoify/lib/appendChild":83}],105:[function(require,module,exports){
...
},{"./ActionBrowseTagline":99,"./icons":108,"yo-yoify/lib/appendChild":83}],106:[function(require,module,exports){
...
},{"./icons":108,"yo-yoify/lib/appendChild":83}],107:[function(require,module,exports){
...
},{"./icons":108}],108:[function(require,module,exports){
...
},{"../../core/Translator":85,"../../core/Utils":87,"./../Plugin":119,"drag-drop":16,"yo-yoify/lib/appendChild":83}],111:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],112:[function(require,module,exports){
...
},{"../../generic-provider-views/index":97,"../../uppy-base/src/plugins/Provider":137,"../Plugin":119,"./icons":111,"yo-yoify/lib/appendChild":83}],113:[function(require,module,exports){
...
},{"./Plugin":119,"on-load":48,"yo-yoify/lib/appendChild":83}],114:[function(require,module,exports){
...
},{"../core/Translator":85,"../core/Utils":87,"./Plugin":119,"yo-yoify/lib/appendChild":83}],115:[function(require,module,exports){
...
},{"../../generic-provider-views/index":97,"../../uppy-base/src/plugins/Provider":137,"../Plugin":119,"yo-yoify/lib/appendChild":83}],116:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function _inherits(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}var _appendChild=require("yo-yoify/lib/appendChild"),_extends=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var r=arguments[e];for(var n in r)Object.prototype.hasOwnProperty.call(r,n)&&(t[n]=r[n])}return t},Plugin=require("./Plugin");module.exports=function(t){function e(r,n){_classCallCheck(this,e);var o=_possibleConstructorReturn(this,t.call(this,r,n));o.type="progressindicator",o.id="Informer",o.title="Informer";var i={typeColors:{info:{text:"#fff",bg:"#000"},warning:{text:"#fff",bg:"#F6A623"},error:{text:"#fff",bg:"#e74c3c"},success:{text:"#fff",bg:"#7ac824"}}};return o.opts=_extends({},i,n),o.render=o.render.bind(o),o}return _inherits(e,t),e.prototype.render=function(t){var e,r,n=t.info.isHidden,o=t.info.msg,i=t.info.type||"info",s="background-color: "+this.opts.typeColors[i].bg+"; color: "+this.opts.typeColors[i].text+";";return r=document.createElement("div"),r.setAttribute("style",""+String(s)),r.setAttribute("aria-hidden",""+String(n)),r.setAttribute("class","Uppy UppyTheme--default UppyInformer"),_appendChild(r,[" ",(e=document.createElement("p"),_appendChild(e,[o]),e)," "]),r},e.prototype.install=function(){var t=this.opts.target,e=this;this.target=this.mount(t,e)},e}(Plugin);
},{"./Plugin":119,"yo-yoify/lib/appendChild":83}],117:[function(require,module,exports){
...
},{"../../generic-provider-views/index":97,"../../uppy-base/src/plugins/Provider":137,"../Plugin":119,"yo-yoify/lib/appendChild":83}],118:[function(require,module,exports){
...
},{"./Plugin":119}],119:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}var yo=require("yo-yo"),nanoraf=require("nanoraf"),_require=require("../core/Utils"),findDOMElement=_require.findDOMElement,getFormData=require("get-form-data");module.exports=function(){function t(e,n){_classCallCheck(this,t),this.core=e,this.opts=n||{},this.type="none",this.opts.replaceTargetContent,this.opts.replaceTargetContent,this.update=this.update.bind(this),this.mount=this.mount.bind(this),this.install=this.install.bind(this),this.uninstall=this.uninstall.bind(this)}return t.prototype.update=function(t){void 0!==this.el&&this.updateUI&&this.updateUI(t)},t.prototype.mount=function(t,e){var n=this,i=e.id,o=findDOMElement(t);if(this.updateUI=nanoraf(function(t){n.el=yo.update(n.el,n.render(t))}),o){if(this.core.log("Installing "+i+" to a DOM element"),this.opts.getMetaFromForm&&"FORM"===o.nodeName){var s=getFormData(o);this.core.setMeta(s)}return this.opts.replaceTargetContent&&(o.innerHTML=""),this.el=e.render(this.core.state),o.appendChild(this.el),o}var r=t,a=(new r).id;return this.core.log("Installing "+i+" to "+a),this.core.getPlugin(a).addTarget(e)},t.prototype.unmount=function(){this.el&&this.el.parentNode&&this.el.parentNode.removeChild(this.el)},t.prototype.install=function(){},t.prototype.uninstall=function(){this.unmount()},t}();
},{"../core/Utils":87,"get-form-data":33,"nanoraf":47,"yo-yo":81}],120:[function(require,module,exports){
...
},{"./Plugin":119,"yo-yoify/lib/appendChild":83}],121:[function(require,module,exports){
...
},{"lodash.throttle":42,"yo-yoify/lib/appendChild":83}],122:[function(require,module,exports){
...
},{"../../core/Utils":87,"../Plugin":119,"./StatusBar":121,"prettier-bytes":52}],123:[function(require,module,exports){
"use strict";function _classCallCheck(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}module.exports=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};_classCallCheck(this,t),this.apiUrl="https://api2.transloadit.com",this.opts=e}return t.prototype.createAssembly=function(t){var e=(t.templateId,t.params),n=t.fields,r=t.signature,s=t.expectedFiles,a=new FormData;return a.append("params","string"==typeof e?e:JSON.stringify(e)),r&&a.append("signature",r),Object.keys(n).forEach(function(t){a.append(t,n[t])}),a.append("tus_num_expected_upload_files",s),fetch(this.apiUrl+"/assemblies",{method:"post",body:a}).then(function(t){return t.json()}).then(function(t){if(t.error){var e=new Error(t.message);throw e.code=t.error,e.status=t,e}return t})},t.prototype.getAssemblyStatus=function(t){return fetch(t).then(function(t){return t.json()})},t}();
...
},{"namespace-emitter":46,"socket.io-client":57,"url-parse":74}],125:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var s=arguments[t];for(var r in s)Object.prototype.hasOwnProperty.call(s,r)&&(e[r]=s[r])}return e},_createClass=function(){function e(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,s,r){return s&&e(t.prototype,s),r&&e(t,r),t}}(),_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise,Plugin=require("../Plugin"),Client=require("./Client"),StatusSocket=require("./Socket");module.exports=function(e){function t(s,r){_classCallCheck(this,t);var o=_possibleConstructorReturn(this,e.call(this,s,r));o.type="uploader",o.id="Transloadit",o.title="Transloadit";var n={strings:{creatingAssembly:"Preparing upload...",creatingAssemblyFailed:"Transloadit: Could not create assembly",encoding:"Encoding..."}},i={waitForEncoding:!1,waitForMetadata:!1,signature:null,params:null,fields:{},getAssemblyOptions:function(e,t){return{params:t.params,signature:t.signature,fields:t.fields}},locale:n};return o.opts=_extends({},i,r),o.locale=_extends({},n,o.opts.locale),o.locale.strings=_extends({},n.strings,o.opts.locale.strings),o.prepareUpload=o.prepareUpload.bind(o),o.afterUpload=o.afterUpload.bind(o),o.opts.params&&o.validateParams(o.opts.params),o.client=new Client,o.sockets={},o}return _inherits(t,e),t.prototype.validateParams=function(e){if(!e)throw new Error("Transloadit: The `params` option is required.");if("string"==typeof e)try{e=JSON.parse(e)}catch(e){throw e.message="Transloadit: The `params` option is a malformed JSON string: "+e.message,e}if(!e.auth||!e.auth.key)throw new Error("Transloadit: The `params.auth.key` option is required. You can find your Transloadit API key at https://transloadit.com/accounts/credentials.")},t.prototype.getAssemblyOptions=function(e){var t=this,s=this.opts;return Promise.all(e.map(function(e){var r=t.core.getFile(e);return Promise.resolve(s.getAssemblyOptions(r,s)).then(function(s){return t.validateParams(s.params),{fileIDs:[e],options:s}})}))},t.prototype.dedupeAssemblyOptions=function(e){var t=Object.create(null);return e.forEach(function(e){var s=e.fileIDs,r=e.options,o=JSON.stringify(r);if(t[o]){var n;(n=t[o].fileIDs).push.apply(n,s)}else t[o]={options:r,fileIDs:[].concat(s)}}),Object.keys(t).map(function(e){return t[e]})},t.prototype.createAssembly=function(e,t){var s=this;return this.core.log("Transloadit: create assembly"),this.client.createAssembly({params:t.params,fields:t.fields,expectedFiles:e.length,signature:t.signature}).then(function(t){function r(e,t){var s=_extends({},e.meta,{assembly_url:t.assembly_url,filename:e.name,fieldname:"file"}),r=_extends({},e.tus,{endpoint:t.tus_url}),o={assembly:t.assembly_id};return _extends({},e,{meta:s,tus:r,transloadit:o})}var o;s.updateState({assemblies:_extends(s.state.assemblies,(o={},o[t.assembly_id]=t,o))});var n=_extends({},s.core.state.files);return e.forEach(function(e){n[e]=r(n[e],t)}),s.core.setState({files:n}),s.core.emit("transloadit:assembly-created",t,e),s.connectSocket(t)}).then(function(){s.core.log("Transloadit: Created assembly")}).catch(function(e){throw s.core.emit("informer",s.opts.locale.strings.creatingAssemblyFailed,"error",0),e})},t.prototype.shouldWait=function(){return this.opts.waitForEncoding||this.opts.waitForMetadata},t.prototype.findFile=function(e){var t=this.core.state.files;for(var s in t)if(t.hasOwnProperty(s)&&t[s].uploadURL===e.tus_upload_url)return t[s]},t.prototype.onFileUploadComplete=function(e,t){var s,r=this.findFile(t);this.updateState({files:_extends({},this.state.files,(s={},s[t.id]={id:r.id,uploadedFile:t},s))}),this.core.bus.emit("transloadit:upload",t,this.getAssembly(e))},t.prototype.onResult=function(e,t,s){var r=this.state.files[s.original_id];s.localId=r?r.id:null,this.updateState({results:this.state.results.concat(s)}),this.core.bus.emit("transloadit:result",t,s,this.getAssembly(e))},t.prototype.onAssemblyFinished=function(e){var t=this;this.client.getAssemblyStatus(e).then(function(e){var s;t.updateState({assemblies:_extends({},t.state.assemblies,(s={},s[e.assembly_id]=e,s))}),t.core.emit("transloadit:complete",e)})},t.prototype.connectSocket=function(e){var t=this,s=new StatusSocket(e.websocket_url,e);return this.sockets[e.assembly_id]=s,s.on("upload",this.onFileUploadComplete.bind(this,e.assembly_id)),s.on("error",function(s){t.core.emit("transloadit:assembly-error",e,s)}),this.opts.waitForEncoding&&s.on("result",this.onResult.bind(this,e.assembly_id)),this.opts.waitForEncoding?s.on("finished",function(){t.onAssemblyFinished(e.assembly_ssl_url)}):this.opts.waitForMetadata&&s.on("metadata",function(){t.onAssemblyFinished(e.assembly_ssl_url),t.core.emit("transloadit:complete",e)}),new _Promise(function(e,t){s.on("connect",e),s.on("error",t)}).then(function(){t.core.log("Transloadit: Socket is ready")})},t.prototype.prepareUpload=function(e){var t=this;e.forEach(function(e){t.core.emit("core:preprocess-progress",e,{mode:"indeterminate",message:t.opts.locale.strings.creatingAssembly})});var s=function(e){var s=e.fileIDs,r=e.options;return t.createAssembly(s,r).then(function(){s.forEach(function(e){t.core.emit("core:preprocess-complete",e)})})};return this.getAssemblyOptions(e).then(function(e){return t.dedupeAssemblyOptions(e)}).then(function(e){return Promise.all(e.map(s))})},t.prototype.afterUpload=function(e){var t=this,s=e[0];if(!this.shouldWait()){var r=this.core.getFile(s);return this.sockets[r.transloadit.assembly].close(),Promise.resolve()}return new _Promise(function(r,o){e.forEach(function(e){t.core.emit("core:postprocess-progress",e,{mode:"indeterminate",message:t.opts.locale.strings.encoding})});var n=function o(n){var i=t.core.getFile(s);n.assembly_id===i.transloadit.assembly&&(t.core.emitter.off("transloadit:complete",o),e.forEach(function(e){t.core.emit("core:postprocess-complete",e)}),r())},i=function r(n,i){var a=t.core.getFile(s);n.assembly_id===a.transloadit.assembly&&(t.core.emitter.off("transloadit:assembly-error",r),e.forEach(function(e){t.core.emit("core:postprocess-complete",e)}),o(i))};t.core.on("transloadit:complete",n),t.core.on("transloadit:assembly-error",i)})},t.prototype.install=function(){this.core.addPreProcessor(this.prepareUpload),this.core.addPostProcessor(this.afterUpload),this.updateState({assemblies:{},files:{},results:[]})},t.prototype.uninstall=function(){this.core.removePreProcessor(this.prepareUpload),this.core.removePostProcessor(this.afterUpload)},t.prototype.getAssembly=function(e){return this.state.assemblies[e]},t.prototype.updateState=function(e){var t=_extends({},this.state,e);this.core.setState({transloadit:t})},_createClass(t,[{key:"state",get:function(){return this.core.state.transloadit||{}}}]),t}(Plugin);
},{"../Plugin":119,"./Client":123,"./Socket":124,"es6-promise":30}],126:[function(require,module,exports){
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _possibleConstructorReturn(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}var _extends=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var o=arguments[t];for(var r in o)Object.prototype.hasOwnProperty.call(o,r)&&(e[r]=o[r])}return e},_Promise="undefined"==typeof Promise?require("es6-promise").Promise:Promise,Plugin=require("./Plugin"),tus=require("tus-js-client"),UppySocket=require("../core/UppySocket"),Utils=require("../core/Utils");require("whatwg-fetch");var tusDefaultOptions={endpoint:"",resume:!0,onProgress:null,onChunkComplete:null,onSuccess:null,onError:null,headers:{},chunkSize:1/0,withCredentials:!1,uploadUrl:null,uploadSize:null,overridePatchMethod:!1,retryDelays:null};module.exports=function(e){function t(o,r){_classCallCheck(this,t);var s=_possibleConstructorReturn(this,e.call(this,o,r));s.type="uploader",s.id="Tus",s.title="Tus";var n={resume:!0,allowPause:!0,autoRetry:!0,retryDelays:[0,1e3,3e3,5e3]};return s.opts=_extends({},n,r),s.handlePauseAll=s.handlePauseAll.bind(s),s.handleResumeAll=s.handleResumeAll.bind(s),s.handleUpload=s.handleUpload.bind(s),s}return _inherits(t,e),t.prototype.pauseResume=function(e,t){var o=_extends({},this.core.getState().files),r=Object.keys(o).filter(function(e){return!o[e].progress.uploadComplete&&o[e].progress.uploadStarted});switch(e){case"toggle":if(o[t].uploadComplete)return;var s=o[t].isPaused||!1,n=!s,i=void 0;return i=s?_extends({},o[t],{isPaused:!1}):_extends({},o[t],{isPaused:!0}),o[t]=i,this.core.setState({files:o}),n;case"pauseAll":return r.forEach(function(e){var t=_extends({},o[e],{isPaused:!0});o[e]=t}),void this.core.setState({files:o});case"resumeAll":return r.forEach(function(e){var t=_extends({},o[e],{isPaused:!1});o[e]=t}),void this.core.setState({files:o})}},t.prototype.handlePauseAll=function(){this.pauseResume("pauseAll")},t.prototype.handleResumeAll=function(){this.pauseResume("resumeAll")},t.prototype.upload=function(e,t,o){var r=this;return this.core.log("uploading "+t+" of "+o),new _Promise(function(t,o){var s=_extends({},tusDefaultOptions,r.opts,e.tus||{});s.onError=function(t){r.core.log(t),r.core.emit("core:upload-error",e.id,t),o("Failed because: "+t)},s.onProgress=function(t,o){r.onReceiveUploadUrl(e,n.url),r.core.emit("core:upload-progress",{uploader:r,id:e.id,bytesUploaded:t,bytesTotal:o})},s.onSuccess=function(){r.core.emit("core:upload-success",e.id,n,n.url),n.url&&r.core.log("Download "+n.file.name+" from "+n.url),t(n)},s.metadata=e.meta;var n=new tus.Upload(e.data,s);r.onFileRemove(e.id,function(e){n.abort(),t("upload "+e+" was removed")}),r.onPause(e.id,function(e){e?n.abort():n.start()}),r.onPauseAll(e.id,function(){n.abort()}),r.onResumeAll(e.id,function(){n.start()}),r.core.on("core:retry-started",function(){var t=r.core.getState().files;t[e.id].progress.uploadComplete||!t[e.id].progress.uploadStarted||t[e.id].isPaused||n.start()}),n.start(),r.core.emit("core:upload-started",e.id,n)})},t.prototype.uploadRemote=function(e,t,o){var r=this;return new _Promise(function(t,o){if(r.core.log(e.remote.url),e.serverToken)r.connectToServerSocket(e);else{var s=r.opts.endpoint;e.tus&&e.tus.endpoint&&(s=e.tus.endpoint),r.core.emitter.emit("core:upload-started",e.id),fetch(e.remote.url,{method:"post",credentials:"include",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify(_extends({},e.remote.body,{endpoint:s,protocol:"tus",size:e.data.size,metadata:e.meta}))}).then(function(s){if(s.status<200&&s.status>300)return o(s.statusText);s.json().then(function(o){var s=o.token;e=r.getFile(e.id),e.serverToken=s,r.updateFile(e),r.connectToServerSocket(e),t()})})}})},t.prototype.connectToServerSocket=function(e){var t=this,o=e.serverToken,r=Utils.getSocketHost(e.remote.host),s=new UppySocket({target:r+"/api/"+o});this.onFileRemove(e.id,function(){return s.send("pause",{})}),this.onPause(e.id,function(e){e?s.send("pause",{}):s.send("resume",{})}),this.onPauseAll(e.id,function(){return s.send("pause",{})}),this.onResumeAll(e.id,function(){return s.send("resume",{})}),s.on("progress",function(o){return Utils.emitSocketProgress(t,o,e)}),s.on("success",function(o){t.core.emitter.emit("core:upload-success",e.id,o,o.url),s.close()})},t.prototype.getFile=function(e){return this.core.state.files[e]},t.prototype.updateFile=function(e){var t,o=_extends({},this.core.state.files,(t={},t[e.id]=e,t));this.core.setState({files:o})},t.prototype.onReceiveUploadUrl=function(e,t){var o=this.getFile(e.id);if(o&&(!o.tus||o.tus.uploadUrl!==t)){var r=_extends({},o,{tus:_extends({},o.tus,{uploadUrl:t})});this.updateFile(r)}},t.prototype.onFileRemove=function(e,t){this.core.on("core:file-removed",function(o){e===o&&t(o)})},t.prototype.onPause=function(e,t){var o=this;this.core.on("core:upload-pause",function(r){if(e===r){var s=o.pauseResume("toggle",e);t(s)}})},t.prototype.onPauseAll=function(e,t){var o=this;this.core.on("core:pause-all",function(){o.core.getFile(e)&&t()})},t.prototype.onResumeAll=function(e,t){var o=this;this.core.on("core:resume-all",function(){o.core.getFile(e)&&t()})},t.prototype.uploadFiles=function(e){var t=this;e.forEach(function(o,r){var s=parseInt(r,10)+1,n=e.length;o.isRemote?t.uploadRemote(o,s,n):t.upload(o,s,n)})},t.prototype.handleUpload=function(e){var t=this;if(0===e.length)return this.core.log("Tus: no files to upload!"),Promise.resolve();this.core.log("Tus is uploading...");var o=e.map(function(e){return t.core.getFile(e)});return this.uploadFiles(o),new _Promise(function(e){t.core.once("core:upload-complete",e)})},t.prototype.actions=function(){var e=this;this.core.on("core:pause-all",this.handlePauseAll),this.core.on("core:resume-all",this.handleResumeAll),this.opts.autoRetry&&this.core.on("back-online",function(){e.core.emit("core:retry-started")})},t.prototype.addResumableUploadsCapabilityFlag=function(){var e=_extends({},this.core.getState().capabilities);e.resumableUploads=!0,this.core.setState({capabilities:e})},t.prototype.install=function(){this.addResumableUploadsCapabilityFlag(),this.core.addUploader(this.handleUpload),this.actions()},t.prototype.uninstall=function(){this.core.removeUploader(this.handleUpload),this.core.off("core:pause-all",this.handlePauseAll),this.core.off("core:resume-all",this.handleResumeAll)},t}(Plugin);
},{"../core/UppySocket":86,"../core/Utils":87,"./Plugin":119,"es6-promise":30,"tus-js-client":72,"whatwg-fetch":78}],127:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],128:[function(require,module,exports){
...
},{"./RecordButton":130,"./SnapshotButton":133,"on-load":48,"yo-yoify/lib/appendChild":83}],129:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],130:[function(require,module,exports){
...
},{"./RecordStartIcon":131,"./RecordStopIcon":132,"yo-yoify/lib/appendChild":83}],131:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],133:[function(require,module,exports){
...
},{"./CameraIcon":127,"yo-yoify/lib/appendChild":83}],134:[function(require,module,exports){
...
},{"yo-yoify/lib/appendChild":83}],135:[function(require,module,exports){
...
},{"../utils/dataURItoFile":139}],139:[function(require,module,exports){
